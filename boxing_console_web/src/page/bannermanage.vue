<template>
    <div class="banner_manage" style="calc(100vw - 230px)">
        ...
        <div class="container">
            <header>
                <el-input v-model="search"  class='myInput_40 margin_rt20' placeholder='请输入名称' style='width:280px'></el-input>
    ...
    export default {
        ...
        methods: {
            getData() {
                ...
                this.search && (this.page = 1,param = {page: this.page, search: this.search});
