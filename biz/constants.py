...
BOXER_APPROVE_STATE_WAITING = "WAITING"
BOXER_APPROVE_STATE_REFUSE = 'REFUSE'
BOXER_APPROVE_STATE_APPROVED = 'APPROVED'

BOXER_APPROVE_STATE_CHOICE = (
    (BOXER_APPROVE_STATE_WAITING, u"待审核"),
    (BOXER_APPROVE_STATE_REFUSE, u"已驳回"),
    (BOXER_APPROVE_STATE_APPROVED, u"已通过")
)
