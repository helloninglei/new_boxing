...
BOXING_USER_ID = 12
SERVICE_USER_ID = 13
VERSION_MANAGER_ID = 10253  # 版本发布账户
...
FAMOUS_USER_DICT = {
    ...
    13636843135: 1082,  # 庞祥
    18210275874: 10056,  # 真探有话说
    18888888818: 10133,  # ISKA
    18888888819: 10134  # 我最皮
}
...
BOXER_ALLOWED_COURSES_FREE_BOXING = "自由搏击"
...
HOT_VIDEO_TAG_ALL = 0
HOT_VIDEO_TAG_MAP = dict(HOT_VIDEO_TAG_CHOICES)

SCHEDULE_STATUS_NOT_PUBLISHED = 1
SCHEDULE_STATUS_PUBLISHED = 2
SCHEDULE_STATUS_CHOICES = (
    (SCHEDULE_STATUS_NOT_PUBLISHED, "未发布"),
    (SCHEDULE_STATUS_PUBLISHED, "已发布")
)

MATCH_CATEGORY_FREE_BOXING = 1
MATCH_CATEGORY_BOXING = 2
MATCH_CATEGORY_MMA = 3
MATCH_CATEGORY_CHOICES = (
    (MATCH_CATEGORY_FREE_BOXING, "自由搏击"),
    (MATCH_CATEGORY_BOXING, "拳击"),
    (MATCH_CATEGORY_MMA, "MMA")
)

MATCH_RESULT_RED_SUCCESS = 1
MATCH_RESULT_BLUE_SUCCESS = 2
MATCH_RESULT_RED_KO_BLUE = 3
MATCH_RESULT_BLUE_KO_RED = 4

MATCH_RESULT_CHOICES = (
    (MATCH_RESULT_RED_SUCCESS, "红方胜"),
    (MATCH_RESULT_BLUE_SUCCESS, "蓝方胜"),
...
APPVERSION_PAST = 'PAST'
APPVERSION_NOW = 'NOW'
APPVERSION_FUTURE = 'FUTURE'
APPVERSION_STATUS_CHOICE = (
    (APPVERSION_PAST, '历史版本'),
    (APPVERSION_NOW, '当前版本'),
    (APPVERSION_FUTURE, '未上线'),
)

VERSION_MANAGER_GROUP = (VERSION_MANAGER_ID,)  # 版本发布管理账号
