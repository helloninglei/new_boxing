...
ORDER_STATUS_NOT_CONFIRMED = 1
ORDER_STATUS_BOXER_CONFIRMED = 2
ORDER_STATUS_USER_CONFIRMED = 3

ORDER_CONFIRM_STATUS = (
    (ORDER_STATUS_NOT_CONFIRMED, '未确认'),
    (ORDER_STATUS_BOXER_CONFIRMED, '拳手已确认'),
    (ORDER_STATUS_USER_CONFIRMED, '用户已确认')
)
