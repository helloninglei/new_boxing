# Generated by Django 2.0.4 on 2018-04-27 16:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='lock_state',
            field=models.CharField(choices=[('LOCKED', '已锁定'), ('UNLOCKED', '已解锁')], default='LOCKED', max_length=10),
        ),
        migrations.AlterField(
            model_name='boxeridentification',
            name='authentication_state',
            field=models.CharField(choices=[('WAITING', '待审核'), ('REFUSE', '已驳回'), ('PASSED', '已通过')], default='WAITING', max_length=10),
        ),
        migrations.AlterField(
            model_name='boxermediaadditional',
            name='media_type',
            field=models.CharField(choices=[('CERTIFICATE_OF_HONOR', '荣誉证书'), ('CONTENSTANT_VIDEO', '参赛视频')], max_length=30),
        ),
        migrations.AlterField(
