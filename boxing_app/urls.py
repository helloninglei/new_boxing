...
from boxing_app.views.shutup_list import ShutUpListReadOnlyViewSet
...
shutup_list_urls = [
    path("shutup_list", ShutUpListReadOnlyViewSet.as_view({"get": "list", "delete": "destroy", "post": "create"})),
]
