...
from boxing_app.views.album import AlbumViewSet, AlbumPictureViewSet, PictureViewSet
...
album_url = [
    ...
    path('pictures/<int:pk>', PictureViewSet.as_view({"get": "retrieve"}), name='picture'),
]
