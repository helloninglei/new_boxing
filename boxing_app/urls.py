...
from boxing_app.views.boxer import BoxerIdentificationViewSet, OrderdBoxerListViewSet
...
boxer_url = [
    ...
    path('nearby/boxers', OrderdBoxerListViewSet.as_view({'post': 'list'}), name='nearby-boxer')
