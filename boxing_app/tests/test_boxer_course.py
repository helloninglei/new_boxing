...
class CourseTestCase(APITestCase):
    ...
    def test_update_boxer_course(self):
        ...
        self.assertEqual(course_list_res.data['validity'].strftime("%Y-%m-%d"), update_course_data['validity'])
        self.assertEqual(course_list_res.data['club_id'], update_course_data['club'])
        self.assertEqual(course_list_res.data['club_name'], self.club_data['name'])
        self.assertEqual(course_list_res.data['club_address'], self.club_data['address'])
        self.assertEqual(str(course_list_res.data['club_longitude']), str(self.club_data['longitude']))
        self.assertEqual(str(course_list_res.data['club_latitude']), str(self.club_data['latitude']))
